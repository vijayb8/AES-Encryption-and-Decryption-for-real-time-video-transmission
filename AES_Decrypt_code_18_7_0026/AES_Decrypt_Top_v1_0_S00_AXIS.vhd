...
entity AES_Decrypt_Axi_Top_v1_0_S00_AXIS is
	generic (
...
end AES_Decrypt_Axi_Top_v1_0_S00_AXIS;

architecture arch_imp of AES_Decrypt_Axi_Top_v1_0_S00_AXIS is
...
begin
	...
	S_AXIS_TREADY	<= I_READY;--axis_tready;
	...
	O_DATA_TLAST <= S_AXIS_TLAST;
	O_DATA_TUSER <= S_AXIS_TUSER;
